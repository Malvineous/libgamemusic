...
#ifndef _CAMOTO_GAMEMUSIC_MUS_CDFM_ZONE66_HPP_
#define _CAMOTO_GAMEMUSIC_MUS_CDFM_ZONE66_HPP_
...
class MusicType_CDFM: virtual public MusicType
{
	public:
...
#endif // _CAMOTO_GAMEMUSIC_MUS_CDFM_ZONE66_HPP_
