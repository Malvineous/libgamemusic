...
#ifndef _CAMOTO_GAMEMUSIC_MUS_MUS_VINYL_HPP_
#define _CAMOTO_GAMEMUSIC_MUS_MUS_VINYL_HPP_
...
/// MusicType implementation for VGFM MUS files.
class MusicType_MUS_Vinyl: virtual public MusicType
{
	public:
...
#endif // _CAMOTO_GAMEMUSIC_MUS_MUS_VINYL_HPP_
