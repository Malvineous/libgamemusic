...
#ifndef _CAMOTO_GAMEMUSIC_MUS_DSM_DSIK_HPP_
#define _CAMOTO_GAMEMUSIC_MUS_DSM_DSIK_HPP_
...
/// MusicType implementation for DSM files.
class MusicType_DSM: virtual public MusicType
{
	public:
...
#endif // _CAMOTO_GAMEMUSIC_MUS_DSM_DSIK_HPP_
